...
bool GameLayer::init() {
	...
	////add enemytypedef std::pair<cocos2d::Vec2, cocos2d::Vec2> VecPair;
	//auto enemy = Enemy::create("Game/playerDown0.png");
	//enemy->setName("enemy");
	//enemy->setScale(4, 4);
	//for (auto& i: map->getEnemyPosition()) {
	//	enemy->setVertices(i.first, i.second);
	//}
